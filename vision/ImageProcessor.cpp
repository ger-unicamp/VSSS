...
ImageProcessor::ImageProcessor(bool _flip, std::string _team_color, ProgramSettings &settings) {
	ImageProcessor(_flip, _team_color);
...
void ImageProcessor::setParameters(ProgramSettings &settings) {
